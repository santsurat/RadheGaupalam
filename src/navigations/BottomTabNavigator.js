    ...
    screenOptions={({ route }) => ({
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarButton: props => (
            <CustomTabBarButton {...props} containerStyle={{marginRight: 0}} />
          ),
        }}
      />
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarButton: props => (
            <CustomTabBarButton {...props} containerStyle={{marginRight: 10}} />
          ),
        }}
      />
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarButton: props => (
            <CustomTabBarButton {...props} containerStyle={{marginLeft: 10}} />
          ),
        }}
      />
      <Tab.Screen
